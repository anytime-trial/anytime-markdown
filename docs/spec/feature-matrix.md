...
| ライブプレビュー | 全 | 両方 | o | o | o | x | ダイアグラム / 数式 / HTML | Mermaid: SVG / PlantUML: 画像 / 数式: KaTeX / HTML: DOMPurify サニタイズ |
| 構文ハイライト | 全 | 両方 | o | o | o | x | コード / ダイアグラム / 数式 / HTML | lowlight（highlight.js common）による言語別ハイライト |
| リサイズ | 全 | 両方 | x | x | o | x | 画像 / ダイアグラム | 右下グリップのドラッグで幅を変更。画像はキーボード操作にも対応 |
| ダブルクリック全画面 | 全 | 両方 | o | o | o | x | ダイアグラム / 数式 / HTML | ダブルクリックでプレビューから全画面を開く |
...
| 機能 | 対応 | 比較 | Readonly | Review | WYSIWYG | Source | 対象 | 備考 |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- | --- |
| 全画面表示 | 全 | 両方 | o | o | o | x | 全ブロック | ツールバーボタンまたはダブルクリック（ダイアグラム / 数式 / HTML） |
...
| 機能 | 対応 | 比較 | Readonly | Review | WYSIWYG | Source | 備考 |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- |
| Alt / Title 編集 | 全 | 両方 | x | x | o | x | 全画面ツールバーから編集 |
