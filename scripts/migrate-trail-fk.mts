...
const TABLES: ReadonlyArray<{ name: string; ddl: string }> = [
  { name: 'activity_sessions', ddl: CREATE_SESSIONS },
  { name: 'activity_session_costs', ddl: CREATE_SESSION_COSTS },
  { name: 'activity_daily_counts', ddl: CREATE_DAILY_COUNTS },
  { name: 'activity_messages', ddl: CREATE_MESSAGES },
  { name: 'activity_session_commits', ddl: CREATE_SESSION_COMMITS },
  { name: 'activity_commit_files', ddl: CREATE_COMMIT_FILES },
  { name: 'activity_session_commit_resolutions', ddl: CREATE_SESSION_COMMIT_RESOLUTIONS },
  { name: 'activity_message_commits', ddl: CREATE_MESSAGE_COMMITS },
  { name: 'activity_current_graphs', ddl: CREATE_CURRENT_GRAPHS },
  { name: 'activity_release_graphs', ddl: CREATE_RELEASE_GRAPHS },
  { name: 'activity_skill_models', ddl: CREATE_SKILL_MODELS },
  { name: 'activity_releases', ddl: CREATE_RELEASES },
  { name: 'activity_release_files', ddl: CREATE_RELEASE_FILES },
  { name: 'activity_release_coverage', ddl: CREATE_RELEASE_COVERAGE },
  { name: 'activity_current_coverage', ddl: CREATE_CURRENT_COVERAGE },
  { name: 'activity_message_tool_calls', ddl: CREATE_MESSAGE_TOOL_CALLS },
  { name: 'activity_c4_manual_elements', ddl: CREATE_C4_MANUAL_ELEMENTS },
  { name: 'activity_c4_manual_relationships', ddl: CREATE_C4_MANUAL_RELATIONSHIPS },
  { name: 'activity_c4_manual_groups', ddl: CREATE_C4_MANUAL_GROUPS },
  { name: 'activity_current_code_graphs', ddl: CREATE_CURRENT_CODE_GRAPHS },
  { name: 'activity_release_code_graphs', ddl: CREATE_RELEASE_CODE_GRAPHS },
  { name: 'activity_current_code_graph_communities', ddl: CREATE_CURRENT_CODE_GRAPH_COMMUNITIES },
  { name: 'activity_release_code_graph_communities', ddl: CREATE_RELEASE_CODE_GRAPH_COMMUNITIES },
  { name: 'activity_current_file_analysis', ddl: CREATE_CURRENT_FILE_ANALYSIS },
  { name: 'release_file_analysis', ddl: CREATE_RELEASE_FILE_ANALYSIS },
  { name: 'activity_current_function_analysis', ddl: CREATE_CURRENT_FUNCTION_ANALYSIS },
...
const TS_NORMALIZE_TARGETS: ReadonlyArray<readonly [table: string, col: string]> = [
  ['activity_sessions', 'commits_resolved_at'],
  ['activity_session_commit_resolutions', 'resolved_at'],
  ['activity_current_graphs', 'updated_at'],
  ['activity_release_graphs', 'updated_at'],
  ['activity_current_code_graphs', 'updated_at'],
  ['activity_current_code_graph_communities', 'generated_at'],
  ['activity_current_code_graph_communities', 'updated_at'],
];
