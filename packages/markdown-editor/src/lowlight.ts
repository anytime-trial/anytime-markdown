 ...
 * `CodeBlockLowlight`）と、markdown-rich-editor の `RichMarkdownEditorPage`（`CodeBlockWithMermaid`）
...
for (const lang of ["math", "mermaid", "plantuml", "anytime-thinking-model", "anytime-diagram"]) {
