...
/**
 * PDF エクスポート用の印刷スタイル定義。
 * window.print() 時に @media print ルールでエディタ本文のみを全展開して印刷する。
 */
export const printStyles: StyleObject = {
  "@page": {
    size: "A4",
    margin: "15mm",
  },
...
/**
 * 印刷スタイルを head へ注入するコンポーネント。
 * @mui/material/GlobalStyles を ui/GlobalStyle へ置換（T5b）。
 */
export const PrintStyles: React.FC = () =>
  React.createElement(GlobalStyle, { styles: printStyles });
