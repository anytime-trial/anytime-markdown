...
import { drawEdgePreview, drawSelectionRect, drawShapePreview, drawSmartGuides, drawSnapHighlight, interpolateViewport, render, resolveEdgesForRender } from '@anytime-markdown/graph-core/engine';
...
export function GraphCanvas({
  ...
  const resolvedEdges = useMemo(
    () => resolveEdgesForRender(nodes, edges, { layoutRunning }),
