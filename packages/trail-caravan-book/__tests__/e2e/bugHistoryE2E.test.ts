/**
 * E2E tests for trail-caravan-book Phase 2.5: runBugHistoryIncremental.
 *
 * These tests spin up:
...
const COMMITS: CommitSeed[] = [
  ...
  },
  {
    ...
    commitMessage: 'feat(trail-caravan-book): implement embeddings',
    committedAt: '2026-03-09T10:00:00.000Z',
    sessionId: 'sess-bug-e2e-5',
    filePaths: ['packages/trail-caravan-book/src/embeddings.ts'],
  },
  {
    ...
    sessionId: 'sess-bug-e2e-5',
    filePaths: ['packages/trail-caravan-book/src/index.ts'],
  },
];
