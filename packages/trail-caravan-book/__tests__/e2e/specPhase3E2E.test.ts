/**
 * E2E tests for trail-caravan-book Phase 3: runSpecIncremental pipeline.
 *
 * Tests:
...
const SPEC_MD = `---
title: "trail-caravan-book 設計書"
date: "2026-01-01"
type: "spec"
lang: "ja"
c4Scope: ["pkg_trail-caravan-book"]
---
...
const MOCK_CLAIMS_RESPONSE = JSON.stringify({
  summary: 'trail-caravan-book spec',
  claims: [
    {
      subject: { type: 'Package', name: 'pkg_trail-caravan-book' },
...
beforeAll(async () => {
  ...
  fs.writeFileSync(path.join(specRoot, 'spec', 'trail-caravan-book.ja.md'), SPEC_MD);
