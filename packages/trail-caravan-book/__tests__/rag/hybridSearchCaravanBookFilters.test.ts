/**
 * hybridSearchCaravanBook の entity_types / since / hops=1 edges/episodes フィルター補完テスト。
 * src/rag/hybridSearchCaravanBook.ts L61-67, L136, L158-183 をカバーする。
 */
...
describe('hybridSearchCaravanBook - filters and hops', () => {
  const dbs: string[] = [];
  ...
  test('bm25Search: FTS テーブルなし の場合は空を返す (hybridSearchCaravanBook 内)', async () => {
