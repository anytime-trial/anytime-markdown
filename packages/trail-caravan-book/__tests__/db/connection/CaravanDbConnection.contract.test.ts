/**
 * CaravanDbConnection 実装 (BetterSqlite3CaravanDb) の挙動を保証する contract テスト。
 *
...
describe('CaravanDbConnection contract (BetterSqlite3)', () => {
  let conn: CaravanDbConnection;

  beforeEach(() => {
    conn = BetterSqlite3CaravanDb.openInCaravan();
    conn.execMany(`
      CREATE TABLE t (
