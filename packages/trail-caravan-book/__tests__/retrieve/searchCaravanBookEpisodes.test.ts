/**
 * searchCaravanBook の episodes 取得・cap/deduplicate ロジックの補完テスト。
 * src/retrieve/searchCaravanBook.ts L188-205 を対象にする。
 */
...
function insertEntity(db: BetterSqlite3CaravanDb, id: string, embedding: Float32Array): void {
...
describe('searchCaravanBook - episodes cap and deduplication', () => {
