...
import { CaravanBookService } from '../CaravanBookService';
...
describe('CaravanBookService', () => {
  ...
  describe('initial state', () => {
    ...
    it('restores persisted pause state on construction', async () => {
      ...
      const svc1 = new CaravanBookService(opts);
      await svc1.pause('cli');
      const svc2 = new CaravanBookService(opts);
