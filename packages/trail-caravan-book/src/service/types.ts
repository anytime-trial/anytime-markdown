 ...
 * デフォルトの pipelineRunner は trail-caravan-book の全パイプラインを順次実行する。
...
export interface CaravanBookServiceOptions {
   ...
   * $TRAIL_HOME/trail-caravan-book-runner.json or <gitRoot>/.anytime/trail/trail-caravan-book-runner.json)
   */
  statePath?: string;
  /**
