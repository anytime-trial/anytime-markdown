...
// avoid coupling. Keep in sync with packages/trail-activity/src/model/types.ts.
 ...
 *
 * Future enhancement: include signature + docstring once trail-activity exposes them.
 */
...
function upsertFunctionEntity(
  ...
  // 現状 signature 抽出が無いため summary は最小限。trail-activity が signature
  // を出すようになったらここを差し替える。
