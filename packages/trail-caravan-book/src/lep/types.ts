 ...
 * - `wave_skipped`:            Wave がスキップされた (例: trail-caravan-book が disabled)
 */
 ...
 * - `memory`:          Wave 3 のみ (要 primary 済データ。trail-caravan-book 単体再解析)
 ...
 * - `tier=3` (memory):  trail-caravan-book ingest pipeline
