 ...
 *   node --experimental-strip-types packages/trail-caravan-book/scripts/evaluate-prompt-quality.mts \
...
// ── Baseline prompt (current trail-caravan-book implementation) ─────────────────────
...
// ── Schemas (same as trail-caravan-book) ─────────────────────────────────────────────
