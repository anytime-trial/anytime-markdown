 ...
 * Self-contained: inlines the trail-caravan-book prompt and zod schema so it runs
 * standalone via `node --experimental-strip-types` without TS path resolution.
 *
 * Usage:
 *   OLLAMA_BASE_URL=http://host.docker.internal:11434 \
 *   node --experimental-strip-types packages/trail-caravan-book/scripts/evaluate-model-quality.mts \
...
// ── Inlined from trail-caravan-book/src/canonical/splitEpisodes.ts ──────────────────
...
// ── Inlined from trail-caravan-book/src/ollama/prompts/conversation.ts ──────────────
...
// ── Inlined from trail-caravan-book/src/ingest/conversation/extractFacts.ts ─────────
