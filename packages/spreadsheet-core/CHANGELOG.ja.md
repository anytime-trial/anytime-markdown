...
- sheet 系のバージョン同期のみ。機能変更はない。

## [0.8.2] - 2026-08-01

### 変更

- Sheet 拡張とのバージョン同期のみ。機能変更なし。

## [0.8.1] - 2026-07-30

### 変更

- `anytime-sheet` 拡張のリリースに合わせたバージョン同期のみ。本パッケージの機能変更はない。

## [0.8.0] - 2026-06-20

### 変更

- sheet リリースセット v0.8.0 に合わせてバージョンを更新（spreadsheet-core 自体の機能変更なし）。

## [0.7.0] - 2026-06-13

### 変更

- sheet リリースセットとのバージョン整合（機能変更なし）。
...
- sheet 系統のバージョン同期のためのバージョン更新（機能変更なし）。

## [0.5.0] - 2026-06-08

### 変更

- sheet 系統のバージョン整合のための bump。機能変更なし。

## [0.4.6] - 2026-05-21

### 変更

- `spreadsheet-core` 全体の SonarCloud 指摘を解消（S2004・S7758・S7780）
- `InMemoryWorkbookAdapter` のカバレッジを 100% に向上（74→100%）
