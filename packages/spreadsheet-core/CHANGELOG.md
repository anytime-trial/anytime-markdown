...
- Version bump only, to keep the sheet line in sync. No functional changes.

## [0.8.2] - 2026-08-01

### Changed

- Version sync with the sheet extension. No functional changes.

## [0.8.1] - 2026-07-30

### Changed

- Version bump only, kept in sync with the `anytime-sheet` extension release. There is no functional change in this package.

## [0.8.0] - 2026-06-20

### Changed

- Version aligned with the sheet release set v0.8.0 (no functional changes in spreadsheet-core itself).

## [0.7.0] - 2026-06-13

### Changed

- Version aligned with the sheet release set (no functional changes).
