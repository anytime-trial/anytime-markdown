...
export function createMcpServer(options: McpGraphOptions): McpServer {
  ...
  server.registerTool(
    'read_graph',
    { description: 'Read a graph document (.graph)', inputSchema: { path: z.string().describe('Relative path to the .graph file') } },
    async ({ path }) => {
  ...
  server.registerTool(
    'write_graph',
    {
      description: 'Write a graph document to a .graph file',
      inputSchema: {
  ...
  server.registerTool(
    'create_graph',
    {
      description: 'Create a new empty graph document',
      inputSchema: {
  ...
  server.registerTool(
    'add_node',
    {
      description: 'Add a node to a graph document (with grid snap)',
      inputSchema: {
        path: z.string().describe('Relative path to the .graph file'),
  ...
  server.registerTool(
    'update_node',
    {
      description: 'Update properties of a node in a graph document',
      inputSchema: {
        path: z.string().describe('Relative path to the .graph file'),
  ...
  server.registerTool(
    'remove_node',
    {
      description: 'Remove a node and its connected edges from a graph document',
      inputSchema: {
        path: z.string().describe('Relative path to the .graph file'),
  ...
  server.registerTool(
    'add_edge',
    {
      description: 'Add an edge between two nodes in a graph document',
      inputSchema: {
        path: z.string().describe('Relative path to the .graph file'),
  ...
  server.registerTool(
    'remove_edge',
    {
      description: 'Remove an edge from a graph document',
      inputSchema: {
        path: z.string().describe('Relative path to the .graph file'),
  ...
  server.registerTool(
    'list_nodes',
    { description: 'List all nodes in a graph document with summary info', inputSchema: { path: z.string().describe('Relative path to the .graph file') } },
    async ({ path }) => {
  ...
  server.registerTool(
    'export_svg',
    { description: 'Export a graph document as SVG', inputSchema: { path: z.string().describe('Relative path to the .graph file') } },
    async ({ path }) => {
  ...
  server.registerTool(
    'export_drawio',
    { description: 'Export a graph document as draw.io XML', inputSchema: { path: z.string().describe('Relative path to the .graph file') } },
    async ({ path }) => {
  ...
  server.registerTool(
    'import_drawio',
    {
      description: 'Import a draw.io XML and create a graph document',
      inputSchema: {
  ...
  server.registerTool(
    'batch_import',
    {
      description: 'Create a graph from structured batch data (nodes + edges)',
      inputSchema: {
        path: z.string().describe('Relative path for the output .graph file'),
