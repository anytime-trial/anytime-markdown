...
- **Source Control diff**: VS Code's standard diff view is not available when Anytime Markdown is the default editor. \
Use the **GIT HISTORY** panel in the "Anytime Markdown" sidebar to view diffs.
