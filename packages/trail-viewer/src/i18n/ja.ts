...
export const ja: TrailI18n = {
  ...
  'flightReview.filter.outcome': '成否',
  'flightReview.filter.outcomeAll': 'すべて',
  'flightReview.filter.since': '開始日',
  'flightReview.filter.until': '終了日',
  'flightReview.filter.tag': 'タグ',
  'flightReview.exportCsv': 'CSV エクスポート',
  'flightReview.loadFailed': 'フライトレビューを取得できません（Trail サーバー停止の可能性）。',
  'flightReview.empty': 'フライトレビューがまだありません',
  'flightReview.outcome.achieved': '達成',
  'flightReview.outcome.partial': '部分達成',
  'flightReview.outcome.unachieved': '未達成',
  'flightReview.outcome.unknown': '不明',
  'flightReview.source.machine': 'machine',
  'flightReview.source.self': 'self',
  'flightReview.source.manual': 'manual',
  'flightReview.column.session': 'セッション',
  'flightReview.column.endedAt': '終了日時',
  'flightReview.column.duration': '所要時間',
  'flightReview.column.outcome': '成否',
  'flightReview.column.source': '判定元',
  'flightReview.column.rework': '手戻り',
  'flightReview.column.toolFailures': 'ツール失敗',
  'flightReview.column.tags': 'タグ',
  'flightReview.detail.title': 'ふりかえり',
  'flightReview.detail.close': '閉じる',
  'flightReview.detail.keyEvents': '主要イベント',
  'flightReview.detail.toolCalls': 'ツール呼出',
  'flightReview.detail.unresolved': '未解決事項',
  'flightReview.detail.nextConcerns': '次回の懸念',
  'flightReview.detail.lessonCandidates': '学習候補',
  'flightReview.detail.userFeedback': 'ユーザーフィードバック',
  'flightReview.detail.none': '記録なし',
  'flightReview.edit.title': '成否の訂正',
  'flightReview.edit.outcome': '成否',
  'flightReview.edit.keepCurrent': '（現状のまま）',
  'flightReview.edit.tags': 'タグ（カンマ区切り）',
  'flightReview.edit.tagsPlaceholder': 'release, ui',
  'flightReview.edit.notes': 'メモ',
  'flightReview.edit.save': '保存',
