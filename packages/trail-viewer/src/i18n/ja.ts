...
export const ja: TrailI18n = {
  ...
  'analytics.combined.workspace': 'ワークスペース',
  'analytics.combined.workspace.description': '表示対象のワークスペースを切り替え（worktree は親リポジトリに合算）',
  ...
  'analytics.combined.periodDays': '期間（日数）',
  'analytics.combined.periodDays.description': '表示する期間を日数で指定（1〜365 日）。Enter またはフォーカスを外すと確定する。',
  'analytics.combined.bucketDay': '1day',
  'analytics.combined.bucketWeek': '1week',
  'analytics.combined.bucketUnit.description': '棒グラフの集計単位。1week は金曜締めで週集計し、日付ドリルダウンは無効になる。',
  ...
  'c4.overlayHelp.busFactor.description':
    'コミット履歴から算出した属人度 (0–1)。主著者のコミット比率で、高いほど「その人しか触っていない」。\n高 (≥0.8) を赤、中 (0.6–0.8) を黄、低 (<0.6) を緑で表示。コミット数が少ない要素は判定しない。\n著者はメールアドレスを持たないため表記ゆれの名寄せはできない。',
  ...
  'c4.busFactor.window': '期間',
  'c4.busFactor.minCommits': '最小コミット数',
  'c4.busFactor.topAuthor': '主著者',
  'c4.busFactor.effectiveAuthors': '実効著者数',
  ...
  // memory tab
  'viewer.tab.caravan': 'パイプライン',
  'caravan.loading': 'CaravanBook DB を読み込み中...',
  'caravan.noDb': 'caravan-book.db が見つかりません',
  'caravan.noDb.description': 'CaravanBook が起動すると自動的にデータが表示されます。',
  ...
  'flightRecord.drift.history.resolved': '解決',
  'flightRecord.drift.history.unresolved': '未解決累計',
  'flightRecord.drift.history.count': '件数',
  'flightRecord.drift.history.empty': '推移を表示できる履歴がありません',
  'flightRecord.drift.severity.info': 'Info',
  'flightRecord.drift.severity.warn': 'Warn',
  'flightRecord.drift.severity.error': 'Error',
  'flightRecord.drift.unresolvedOnly': '未解決のみ',
  'flightRecord.drift.filterSeverity': '重要度',
  'flightRecord.drift.filterType': '種別',
  'flightRecord.drift.resolve': '解決済みにする',
  'flightRecord.drift.resolved': '解決済み',
  'flightRecord.drift.resolutionNote': '解決メモ',
  'flightRecord.drift.detail': '詳細',
  'flightRecord.drift.typeDescription.spec_vs_code': '設計書 ↔ コードで値が食い違う',
  'flightRecord.drift.typeDescription.conv_vs_code': '会話 ↔ コードで値が食い違う',
  'flightRecord.drift.typeDescription.conv_vs_spec': '会話 ↔ 設計書で値が食い違う',
  ...
  'flightRecord.drift.typeDescription.spec_clarification_recurring': '同義の質問が embedding 類似度 0.85+ で再発',
  'flightRecord.drift.fixTarget': '修正対象',
  'flightRecord.drift.fixTarget.code': 'Code',
  'flightRecord.drift.fixTarget.spec': 'Spec',
  'flightRecord.drift.fixTarget.conv': 'Conv',
  'flightRecord.bugfix.empty': 'バグ記録はありません',
  'flightRecord.bugfix.recurring': '繰り返しバグ',
  'flightRecord.bugfix.history': 'バグ修正履歴',
  'flightRecord.bugfix.filterPackage': 'パッケージ',
  'flightRecord.bugfix.filterCategory': 'カテゴリ',
  'flightRecord.bugfix.column.summary': '概要',
  'flightRecord.bugfix.column.date': '修正日',
  'flightRecord.bugfix.column.category': 'カテゴリ',
  'flightRecord.bugfix.causedBy.title': '原因エンティティ',
  'flightRecord.bugfix.causedBy.empty': '原因エンティティなし',
  ...
  'flightRecord.bugfix.causal.rootCauses': '根本原因カテゴリ',
  'flightRecord.bugfix.causal.noCauses': 'この bug に紐づく因果情報はありません',
  'flightRecord.bugfix.causal.bugsUnit': '件',
  'flightRecord.bugfix.causal.findingsUnit': '件',
  'caravan.runs.empty': 'パイプラインランはありません',
  'caravan.runs.filterScope': 'スコープ',
  'caravan.runs.filterStatus': 'ステータス',
  'caravan.runs.filterWave': 'Wave',
  'caravan.runs.failedItems': '失敗アイテム',
  'caravan.runs.timeline': 'パイプライン実行',
  'caravan.runs.runList': '実行一覧',
  'caravan.runs.errorDetail': 'エラー詳細',
  'caravan.runs.logs': 'ログ',
  'caravan.runs.wave.all': 'すべて',
  'caravan.runs.column.startedAt': '開始時刻',
  'caravan.runs.column.timestamp': '時刻',
  'caravan.runs.column.scope': 'スコープ',
  'caravan.runs.column.wave': 'Wave',
  'caravan.runs.column.status': 'ステータス',
  'caravan.runs.column.duration': '所要時間',
  'caravan.runs.column.itemsProcessed': '処理件数',
  'caravan.runs.column.level': 'レベル',
  'caravan.runs.column.component': 'コンポーネント',
  'caravan.runs.column.message': 'メッセージ',
  'caravan.runs.column.key': 'キー',
  'caravan.runs.column.attempts': '試行回数',
  'caravan.runs.column.reason': '理由',
  'caravan.runs.column.detail': '詳細',
  'caravan.runs.status.running': '実行中',
  ...
  'caravan.chat.rebuild': 'インデックス再構築',
  'caravan.chat.sources.title': '参照ソース',
  'caravan.chat.sources.empty': '参照されたソースはまだありません',
  'caravan.chat.filters.title': 'フィルタ',
  'caravan.chat.filters.allRepos': '全リポジトリ',
  'caravan.chat.filters.currentRepo': '現在のリポジトリのみ',
  'caravan.chat.setup.title': 'Ollama に接続できません',
  'caravan.chat.setup.step1': '1. Ollama をインストール: https://ollama.com',
  'caravan.chat.setup.step2': '2. ollama pull bge-m3 と ollama pull qwen2.5-coder:14b を実行',
  'caravan.chat.setup.step3': '3. 下の [接続を確認] ボタンを押す',
  'caravan.chat.setup.recheck': '接続を確認',
  'caravan.chat.empty': '関連する記憶が見つかりませんでした',
  'caravan.chat.error': 'エラー',
  'caravan.chat.interrupted': '中断されました',
  ...
  'emergency.fab.label': '緊急停止',
  'emergency.status.active': 'Kill Switch 発動中',
  'emergency.status.inactive': '平常',
  'emergency.status.unknown': '状態不明',
  'emergency.panel.title': '緊急停止（Kill Switch）',
  'emergency.panel.close': '閉じる',
  'emergency.activeSince': '発動時刻',
  'emergency.triggeredBy': '発動者',
  'emergency.reason.label': '理由',
  'emergency.reason.placeholder': '例: 暴走ループ・破壊的操作の進行中',
  'emergency.reason.required': '理由を入力してください',
  'emergency.action.activate': 'Kill Switch を発動',
  'emergency.action.release': 'Kill Switch を解除',
  'emergency.confirm.activateTitle': 'Kill Switch を発動しますか？',
  'emergency.confirm.activateBody':
    'このワークスペースの全 Claude Code セッションでツール実行が遮断されます。',
  'emergency.confirm.releaseTitle': 'Kill Switch を解除しますか？',
  'emergency.confirm.releaseBody': '遮断を解除し、ツール実行を再開できる状態に戻します。',
  'emergency.confirm.rollbackTitle': '復旧ブランチを作成しますか？',
  'emergency.confirm.rollbackBody':
    'ブランチ {{branch}} を作成します。現在の作業ツリーと履歴は変更されません（非破壊）。',
  'emergency.confirm.ok': '実行',
  'emergency.confirm.cancel': 'キャンセル',
  'emergency.feedback.cancelled': 'キャンセルしました。何も実行していません。',
  'emergency.feedback.activated': 'Kill Switch を発動しました。ツール実行は遮断されています。',
  'emergency.feedback.released': 'Kill Switch を解除しました。',
  'emergency.feedback.rolledBack': '復旧ブランチ {{branch}} を作成しました。',
  'emergency.feedback.failed': '失敗しました: {{error}}',
  'emergency.safePoints.title': 'セーフポイント',
  'emergency.safePoints.empty': 'セーフポイントがまだありません',
  'emergency.safePoints.autoLabel': '(自動: セッション終了)',
  ...
  'knowledgeGraph.empty': '知識グラフにデータがありません',
  'knowledgeGraph.reload': '再読込',
  'knowledgeGraph.typeFilter': '種別',
  'knowledgeGraph.typeAll': '全種別',
  'knowledgeGraph.nodeLimit': '表示件数',
  // カード表示（card スキン）で 1 列に縦へ積む枚数。超えた分はカラム内で右へ折り返す
  'knowledgeGraph.cardRows': 'カードの縦の枚数',
  'knowledgeGraph.nodeLimitSlowSuffix': '（数秒）',
  'knowledgeGraph.shownCount': '表示 {{shown}} / 全 {{total}} 件',
  'knowledgeGraph.searchPlaceholder': '検索（ファイル名・概念・Bug…）',
  'knowledgeGraph.searchRun': '検索',
  'knowledgeGraph.searchNoMatch': '一致なし',
  'knowledgeGraph.searchFailed': '検索できません（Trail サーバー停止の可能性）',
  'knowledgeGraph.egoShownCount': '{{label}} の周辺 {{shown}} 件',
  'knowledgeGraph.egoClear': '全体表示へ戻る',
  'knowledgeGraph.agentSearches': 'エージェント照会',
  'knowledgeGraph.agentSearchesEmpty': 'エージェント照会はまだありません',
  'knowledgeGraph.agentSearchesFailed': 'エージェント照会を取得できません（Trail サーバー停止の可能性）',
  'knowledgeGraph.agentSearchHitCount': '{{count}} 件',
  'knowledgeGraph.entityNotFound': '引用された実体が見つかりません',
  'flightRecord.filter.outcome': '成否',
  'flightRecord.filter.outcomeAll': 'すべて',
  'flightRecord.filter.since': '開始日',
  'flightRecord.filter.until': '終了日',
  'flightRecord.filter.tag': 'タグ',
  'flightRecord.filter.workspace': 'ワークスペース',
  'flightRecord.filter.workspaceAll': 'すべてのワークスペース',
  ...
  'flightRecord.outcome.unknown': '不明',
  'flightRecord.source.machine': 'machine',
  'flightRecord.source.self': 'self',
  'flightRecord.source.manual': 'manual',
  'flightRecord.column.instruction': '指示',
  'flightRecord.column.workspace': 'ワークスペース',
  'flightRecord.column.sessions': 'セッション数',
  'flightRecord.column.deliverables': '成果物',
  'flightRecord.column.verifications': '検証',
  'flightRecord.column.tokens': 'トークン',
  'flightRecord.column.cost': '費用',
  'flightRecord.undeclared': '（指示の宣言なし）',
  'flightRecord.notImported': '未取込',
  'flightRecord.deliverableCounts': '文書 {docs} / コード {code}',
  'flightRecord.detail.startedAt': '開始日時',
  'flightRecord.detail.deliverables': '成果物',
  'flightRecord.detail.verifications': '検証の実施',
  'flightRecord.verification.dirtyTree': '未コミット状態で実行',
  'flightRecord.detail.uncommitted': '未コミット',
  'flightRecord.detail.bugFixed': 'Bug Fixed',
  'flightRecord.detail.bugFixedAll': 'すべて Bug Fixed タブで見る',
  'flightRecord.detail.tokenUsage': 'トークン消費',
  'flightRecord.detail.sessions': '所属セッション',
  'flightRecord.token.model': 'モデル',
  'flightRecord.token.input': '入力',
  'flightRecord.token.output': '出力',
  'flightRecord.token.cacheRead': 'キャッシュ読取',
  'flightRecord.token.cacheCreation': 'キャッシュ作成',
  'flightRecord.token.cost': '費用',
  'flightRecord.column.session': 'セッション',
  'flightRecord.column.endedAt': '終了日時',
  'flightRecord.column.duration': '所要時間',
  'flightRecord.column.outcome': '成否',
  'flightRecord.column.source': '判定元',
  'flightRecord.column.rework': '手戻り',
  'flightRecord.column.toolFailures': 'ツール失敗',
  'flightRecord.column.tags': 'タグ',
  'flightRecord.column.findings': '指摘',
  'flightRecord.tab.instruction': '指示',
  ...
  'flightRecord.findings.column.severity': '重大度',
  'flightRecord.findings.column.category': 'カテゴリ',
  'flightRecord.findings.column.target': '対象',
  'flightRecord.findings.column.finding': '指摘',
  'flightRecord.findings.column.reviewedAt': 'レビュー日',
  'flightRecord.findings.column.status': '状態',
  'flightRecord.findings.noneFiltered': '絞り込みに一致する指摘はありません（条件を緩めてください）',
  'flightRecord.findings.filter.severity': '重大度',
  'flightRecord.findings.filter.severityAll': 'すべての重大度',
  'flightRecord.findings.filter.category': 'カテゴリ',
  ...
  'flightRecord.detail.toolCalls': 'ツール呼出',
  'flightRecord.detail.unresolved': '未解決事項',
  'flightRecord.detail.nextConcerns': '次回の懸念',
  'flightRecord.detail.lessonCandidates': '学習候補',
  'flightRecord.detail.userFeedback': 'ユーザーフィードバック',
  'flightRecord.detail.none': '記録なし',
  'flightRecord.edit.title': '成否の訂正',
  'flightRecord.edit.outcome': '成否',
  'flightRecord.edit.keepCurrent': '（現状のまま）',
  'flightRecord.edit.tags': 'タグ（カンマ区切り）',
  'flightRecord.edit.tagsPlaceholder': 'release, ui',
  'flightRecord.edit.notes': 'メモ',
  'flightRecord.edit.save': '保存',
  'flightRecord.edit.saving': '保存中…',
  'flightRecord.edit.saveSuccess': '保存しました（manual として記録）',
  'flightRecord.edit.saveError': '保存に失敗しました',
  // flightReview rationale audit (Phase 6 S4)
  'flightRecord.column.audit': '監査',
  'flightRecord.audit.label': '決定根拠の監査',
  'flightRecord.audit.save': '監査を保存',
  'flightRecord.audit.unaudited': '未実施',
  'flightRecord.audit.valid': '妥当',
  'flightRecord.audit.needsFix': '要修正',
  'flightRecord.audit.rejected': '棄却',
  'flightRecord.rationale.title': '決定根拠（Rationale）',
  'flightRecord.rationale.confidenceFilter': '信頼度',
  'flightRecord.rationale.filterAll': 'すべて',
  'flightRecord.rationale.empty': 'このセッションのコミットに紐付く決定根拠ノードはありません',
  'flightRecord.audit.saveSuccess': '監査を保存しました',
  'flightRecord.audit.saveError': '監査の保存に失敗しました',
};
