...
export const ja: TrailI18n = {
  ...
  'metrics.title': '品質指標',
  'metrics.period.last7d': '7日',
  'metrics.period.last30d': '30日',
  'metrics.period.last90d': '90日',
  'metrics.deploymentFrequency.name': 'デプロイ頻度',
  'metrics.deploymentFrequency.description': '期間内の 1 日あたりリリース数',
  'metrics.leadTimeForChanges.name': 'リードタイム',
  'metrics.leadTimeForChanges.description': 'プロンプトからコミット検出までの中央値',
  'metrics.promptToCommitSuccessRate.name': 'コミット成功率',
  'metrics.promptToCommitSuccessRate.description': 'コミットを生成した user プロンプトの割合',
