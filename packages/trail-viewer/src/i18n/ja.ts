...
export const ja: TrailI18n = {
  ...
  'memory.drift.history.title': 'ドリフト件数の推移（日次・JST）',
  'memory.drift.history.detected': '検知',
  'memory.drift.history.resolved': '解決',
  'memory.drift.history.unresolved': '未解決累計',
  'memory.drift.history.count': '件数',
  'memory.drift.history.empty': '推移を表示できる履歴がありません',
  ...
  'memory.review.filterAll': 'すべて',
  'memory.review.workspaceUnresolved': '(未解決)',
  ...
  'memory.runs.runList': '実行一覧',
  'memory.runs.invalidations': '無効化履歴',
  'memory.runs.errorDetail': 'エラー詳細',
  'memory.runs.logs': 'ログ',
  'memory.runs.wave.all': 'すべて',
  'memory.runs.column.startedAt': '開始時刻',
  'memory.runs.column.timestamp': '時刻',
  'memory.runs.column.scope': 'スコープ',
  'memory.runs.column.wave': 'Wave',
  'memory.runs.column.status': 'ステータス',
  'memory.runs.column.duration': '所要時間',
  'memory.runs.column.itemsProcessed': '処理件数',
  'memory.runs.column.level': 'レベル',
  'memory.runs.column.component': 'コンポーネント',
  'memory.runs.column.message': 'メッセージ',
  'memory.runs.column.key': 'キー',
  'memory.runs.column.attempts': '試行回数',
  'memory.runs.column.reason': '理由',
  'memory.runs.column.detail': '詳細',
