...
export interface TrailI18n {
  ...
  'viewer.tab.flightReview': string;
  'flightReview.filter.outcome': string;
  'flightReview.filter.outcomeAll': string;
  'flightReview.filter.since': string;
  'flightReview.filter.until': string;
  'flightReview.filter.tag': string;
  'flightReview.exportCsv': string;
  'flightReview.loadFailed': string;
  'flightReview.empty': string;
  'flightReview.outcome.achieved': string;
  'flightReview.outcome.partial': string;
  'flightReview.outcome.unachieved': string;
  'flightReview.outcome.unknown': string;
  'flightReview.source.machine': string;
  'flightReview.source.self': string;
  'flightReview.source.manual': string;
  'flightReview.column.session': string;
  'flightReview.column.endedAt': string;
  'flightReview.column.duration': string;
  'flightReview.column.outcome': string;
  'flightReview.column.source': string;
  'flightReview.column.rework': string;
  'flightReview.column.toolFailures': string;
  'flightReview.column.tags': string;
  'flightReview.detail.title': string;
  'flightReview.detail.close': string;
  'flightReview.detail.keyEvents': string;
  'flightReview.detail.toolCalls': string;
  'flightReview.detail.unresolved': string;
  'flightReview.detail.nextConcerns': string;
  'flightReview.detail.lessonCandidates': string;
  'flightReview.detail.userFeedback': string;
  'flightReview.detail.none': string;
  'flightReview.edit.title': string;
  'flightReview.edit.outcome': string;
  'flightReview.edit.keepCurrent': string;
  'flightReview.edit.tags': string;
  'flightReview.edit.tagsPlaceholder': string;
  'flightReview.edit.notes': string;
  'flightReview.edit.save': string;
