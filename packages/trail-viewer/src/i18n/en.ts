...
export const en: TrailI18n = {
  ...
  'metrics.leadTimeForChanges.name': 'Lead Time for Changes',
  'metrics.leadTimeForChanges.description': 'Median time from prompt to commit detection',
  'metrics.promptToCommitSuccessRate.name': 'Commit Success Rate',
  'metrics.promptToCommitSuccessRate.description': 'User prompts that generated at least one commit',
