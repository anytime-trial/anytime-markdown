...
export function mountSetupGuide(
  ...
  function render(): void {
    ...
    title.textContent = props.t('caravan.chat.setup.title');
    ...
    for (const key of [
      'caravan.chat.setup.step1',
      'caravan.chat.setup.step2',
      'caravan.chat.setup.step3',
    ]) {
    ...
    const { el: btn } = createButton({
      variant: 'contained',
      label: props.t('caravan.chat.setup.recheck'),
