// user_feedback_entries は Flight Record 移設（2026-08-07・memory-core.db 行き）の対象外で
// trail.db / TrailDatabase 側に残る。旧 TrailDatabase.flightReview.test.ts の S2 ブロックに
