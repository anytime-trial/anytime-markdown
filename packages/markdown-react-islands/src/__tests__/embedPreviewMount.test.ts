...
jest.mock("@anytime-markdown/markdown-viewer/src/utils/embedInfoString", () => ({
...
import {
  ...
  getEmbedStoredWidth,
  isEmbedResizable,
} from "@anytime-markdown/markdown-rich/src/components/codeblock/previewContracts";
import { parseEmbedInfoString } from "@anytime-markdown/markdown-viewer/src/utils/embedInfoString";
