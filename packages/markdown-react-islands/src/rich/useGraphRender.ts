...
import { BoundedMap } from "@anytime-markdown/markdown-rich/src/utils/BoundedMap";
import type { GraphExpr } from "@anytime-markdown/markdown-rich/src/utils/latexToExpr";

/** Lazy-load latexToExpr (includes mathjs ~180KB) */
let parseLatexToGraphFn: typeof import("@anytime-markdown/markdown-rich/src/utils/latexToExpr").parseLatexToGraph | null = null;
async function getParser() {
  parseLatexToGraphFn ??= (await import("@anytime-markdown/markdown-rich/src/utils/latexToExpr")).parseLatexToGraph;
