...
- Replaced the Marketplace icon with the camel-and-diamond design shared across the Anytime extensions.
...
- First stable release. The bundled co-occurrence viewer and graph engine now have a settled public surface, so the extension moves to 1.0.0.
