      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 6 } }}>
        <Box component="header" sx={{ mb: 3 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ maxWidth: '60ch', lineHeight: 1.8 }}>
            日次技術調査レポートが観測した Claude Code 本体と Claude モデルのリリースを、
            時系列に並べたものです。changelog の全件ではなく、
            {sourceReportCount} 本のレポートが実際に取り上げたリリースを収録しています。
          </Typography>
        </Box>
        ...
        <Typography variant="caption" component="p" sx={{ mt: 6, color: 'text.disabled', lineHeight: 1.8 }}>
          出典は各リリースの「変更点」を開くと確認できます。日付にヘルプアイコンが付くものは、
          レポート本文にリリース日の明記が無く、レポート発行日で代用した推定日です。
        </Typography>
    </Container>
  );
}
