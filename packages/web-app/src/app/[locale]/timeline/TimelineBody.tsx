...
export default function TimelineBody({ entries, sourceReportCount, period }: Props) {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 4, md: 6 } }}>
      ...
      <Box component="section" aria-labelledby="release-track-heading">
        ...
        <Typography
          ...
          sx={{ maxWidth: '60ch', lineHeight: 1.8 }}
        >
          {`Claude Code 本体と Claude モデルのリリースを、新しい順（上ほど最近）に並べたものです。changelog の全件ではなく、${sourceReportCount} 本のレポートが実際に取り上げたリリースを収録しています。`}
        </Typography>
