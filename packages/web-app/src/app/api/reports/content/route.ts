...
import { REPORTS_PREFIX } from '../../../../lib/reportClient';
import { CLOUDFRONT_URL, DOCS_BUCKET, fetchFromCdn, s3Client } from '../../../../lib/s3Client';
...
export async function GET(request: NextRequest) {
  ...
  if (!key.startsWith(REPORTS_PREFIX) || !key.endsWith('.md')) {
