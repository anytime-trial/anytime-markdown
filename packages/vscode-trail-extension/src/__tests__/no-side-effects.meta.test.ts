...
const WATCHED_FILES = [
  path.join(os.homedir(), '.claude', 'trail', 'activity.db'), // test-safety-allow: 保護領域の副作用を監視するメタテスト
  path.join(os.homedir(), '.claude', 'trail', 'activity.db_bak'), // test-safety-allow: 同上
];
