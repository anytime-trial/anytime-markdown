...
- No changes in this package; version synchronized with the Anytime Trail extension 1.6.0.
...
- Version bumped to stay in sync with the trail release set. No functional change in this package.
