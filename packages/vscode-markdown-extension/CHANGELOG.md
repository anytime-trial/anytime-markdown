...
- Bundled skills updated. `anytime-doc-authoring` now carries the clarity review previously held by an archived skill, and skill descriptions were shortened to reduce startup context (`anytime-markdown-output`, `anytime-markdown-usage`, `anytime-reverse-spec`).
